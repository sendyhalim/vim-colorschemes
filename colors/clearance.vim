...
hi PreProc        guifg=#657380    guibg=NONE       gui=bold
hi Conditional    guifg=#6d90d1    guibg=NONE       gui=bold

hi Todo           guifg=#8f8f8f    guibg=NONE       gui=NONE
hi Constant       guifg=#657380    guibg=NONE       gui=bold

hi Identifier     guifg=#657380    guibg=NONE       gui=bold
hi Function       guifg=#60FF41    guibg=NONE       gui=bold
hi Type           guifg=#ffffb6    guibg=NONE       gui=bold
hi Statement      guifg=#6d90d1    guibg=NONE       gui=bold

hi Special        guifg=#eb7a4b    guibg=NONE       gui=italic,bold
...
" Scala
hi scalaFqn 	  guifg=#60FF41    guibg=NONE       gui=bold
